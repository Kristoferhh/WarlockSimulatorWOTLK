  ...
  fetch("./WarlockSim.wasm")
    ...
    .then((module) => {
      try {
        ...
        talents.demonicEmbrace = parseInt(
          playerData.Talents["Demonic Embrace"]
        );
        ...
        talents.masterConjuror = parseInt(
          playerData.Talents["Master Conjuror"]
        );
        ...
        talents.demonicTactics = parseInt(
          playerData.Talents["Demonic Tactics"]
        );
        ...
        talents.summonFelguard = parseInt(
          playerData.Talents["Summon Felguard"]
        );
        ...
        playerSettings.hasShadowfury =
          playerData.Rotation.Other.includes(30283);
