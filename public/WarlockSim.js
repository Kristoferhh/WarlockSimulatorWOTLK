var WarlockSim = (function () {
  ...
  return function (WarlockSim) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module["ready"], "___set_stack_limits")
    ) {
    ...
    var ASM_CONSTS = {
      35548: function ($0) {
        postMessage({ event: "dpsUpdate", data: { dps: $0 } });
      },
      35604: function ($0) {
        postMessage({
          event: "errorCallback",
          data: { errorMsg: UTF8ToString($0) },
        });
      },
      35683: function ($0, $1, $2) {
        postMessage({
          event: "combatLogVector",
          data: { name: UTF8ToString($0), manaGain: $1, damage: $2 },
        });
      },
      35791: function ($0, $1, $2, $3, $4, $5, $6, $7) {
        postMessage({
      ...
      35999: function ($0) {
        postMessage({
          ...
          data: { combatLogEntry: UTF8ToString($0) },
        });
      },
      36086: function ($0, $1, $2, $3, $4) {
        postMessage({
          event: "update",
          data: {
            medianDps: $0,
...
else if (typeof exports === "object") exports["WarlockSim"] = WarlockSim;
